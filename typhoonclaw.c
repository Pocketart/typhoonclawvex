...
void auto_bottomut(float t);//move bottom claw out (millisecond)
...
void moveScissor(){
	if (SensorValue(I2C_1) > SensorValue(I2C_2)){
		...
		motor[scissor_right] = vexRT[Ch3]+vexRT[Ch3]*moveScissor_p;
		motor[scissor_left] = vexRT[Ch3];
	}else if(SensorValue(I2C_1) < SensorValue(I2C_2)){
		//difference = SensorValue(I2C_2) - SensorValue(I2C_1);
  	motor[scissor_left] = vexRT[Ch3]+vexRT[Ch3]*moveScissor_p;
  	motor[scissor_right] = vexRT[Ch3];
  }else{
  	motor[scissor_left] = vexRT[Ch3];
  	motor[scissor_right] = vexRT[Ch3];
  }
