...
#pragma config(Motor,  port3,           scissor_left,  tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port4,           scissor_right, tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_2)
